            ...
            VStack {
                ...
                ZStack {
                    ...
                    HStack {
                        ...
                        TabBarIcon(viewRouter: viewRouter, assignedPage: .liked, width: geometry.size.width/5, height: geometry.size.height/28, systemIconName: "list.number", tabName: "Maxes")
                        ZStack {
                            Circle()
                        ...
                        TabBarIcon(viewRouter: viewRouter, assignedPage: .records, width: geometry.size.width/5, height: geometry.size.height/28, systemIconName: "person.2.fill", tabName: "Groups")
